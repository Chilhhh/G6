...
public class pdfProducer_school {
	...
	private static Font myfont(float size, int style) throws DocumentException, IOException {
		BaseFont bfChinese = BaseFont.createFont("resources/home/STFANGSO.TTF", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
		Font myFont = new Font(bfChinese, size, style);
		return myFont;
	}
	...
	private static PdfPTable add_headtitle_1(String text) throws Exception {
		...
		// 带前导图(方法1)地址
		// String imagePath2 = "resources/home/hadoop/Pictures/line.png"; //图片为2px*11px
	...
	private static void add_certExpTable(Document doc) throws Exception {
		...
		String certImgPath = "resources/home/hcert.jpeg";
	...
	public static void pdfProducer(ArrayList<Student> students) throws Exception {
		...
		for (Student student : students) {
			try {
				...
				// 头像
				String headImgPath = "resources/home/hcert.jpeg";

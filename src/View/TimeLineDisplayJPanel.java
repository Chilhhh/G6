...
//     * @param infoReader
//     */
//    public TimeLineDisplayJPanel(InfoReader infoReader) {
//        //获取infoReader
...
//        integrate();
//
//        mainJFrame.setContentPane(this);
...
//        lessonTableJPanel.setBackground(Color.red);
        ...
        for (Course course : courses.getCourses()) {
            ...
            lessonListJPanel[course.getCourseTerm()].add(generateLessonJButton(course));
        }
    ...
    public void clickLessonJButton(Course course) {
        ...
        //new一个JLabel为introJLabel用来显示课程简介，并设置文本水平居中
